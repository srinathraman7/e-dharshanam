...
import { ArrowRight, Sparkles, MapPin, Calendar, Shield } from "lucide-react";
...
const features = [
  {
    icon: Calendar,
    title: "Easy Booking",
    description: "Book darshan tickets in advance with just a few clicks",
  },
  {
    icon: MapPin,
    title: "All India Coverage",
    description: "Access to temples across every state and union territory",
  },
  {
    icon: Shield,
    title: "Secure & Trusted",
    description: "Safe payments and verified temple partnerships",
  },
];
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
          <motion.img
            ...
            src={mandalaPattern}
            alt=""
            className="w-[1000px] h-[1000px] animate-mandala"
          />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 text-primary-foreground mb-6"
            >
            ...
            <p className="text-primary-foreground/80 text-lg md:text-xl max-w-2xl mx-auto mb-8">
              Book darshan tickets to the most revered temples across India.
              Experience seamless spiritual journeys with DivineDarshan.
            </p>
            ...
            >
              <Link
                to="/temples"
                className="btn-divine inline-flex items-center gap-2 text-lg px-8 py-4"
              >
                Explore Temples
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4">
              Why Choose DivineDarshan?
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
              We make your spiritual journey seamless and memorable
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="glass-card p-8 text-center hover:shadow-hover transition-shadow duration-300"
              >
                <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-vermillion flex items-center justify-center shadow-divine">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground max-w-xl">
                Discover the most visited sacred destinations across India
              </p>
            </div>
            <Link
              to="/temples"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-primary-foreground/80 text-lg max-w-xl mx-auto mb-8">
              Join thousands of devotees who have found peace through our platform
            </p>
            <Link
              to="/temples"
