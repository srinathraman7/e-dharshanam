    ...
    return (
      <Layout>
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <button onClick={() => navigate("/temples")} className="btn-divine">
            Back to Temples
          </button>
        </div>
      </Layout>
  ...
  const handleBooking = () => {
    ...
    navigate("/confirmation", {
      state: {
        ...
        ticketType,
        totalAmount:
          ticketCount * (ticketType === "vip" ? temple.vipPrice : temple.ticketPrice),
      },
    });
  };
    ...
    <Layout>
      ...
      <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
        ...
        <button
          ...
          className="absolute top-24 left-4 md:left-8 z-10 flex items-center gap-2 px-4 py-2 rounded-full glass-card text-foreground hover:bg-card/90 transition-colors"
        >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
          <div className="container mx-auto">
            ...
            >
              <span className="inline-block px-3 py-1 rounded-full bg-primary text-primary-foreground text-sm mb-4">
                {temple.deity}
              </span>
              ...
              <div className="flex flex-wrap items-center gap-4 text-primary-foreground/80">
                ...
                <span className="flex items-center gap-2">
                  <Star className="w-5 h-5 fill-marigold text-marigold" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div
              ...
              className="glass-card p-6"
            >
              <h2 className="font-serif text-2xl font-semibold mb-4">History & Heritage</h2>
              <p className="text-muted-foreground leading-relaxed">
                {showFullHistory ? temple.history : `${temple.history.slice(0, 200)}...`}
              </p>
              <button
            ...
            <div className="glass-card p-6 space-y-6">
              ...
              <div>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <button
                      className={cn(
                        "w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-border bg-card text-left hover:bg-accent/50 transition-colors",
                  ...
                  {temple.vipPrice > 0 && (
                    <button
                      ...
                      className={cn(
                        "flex flex-col items-center px-4 py-3 rounded-xl border transition-all",
                        ticketType === "vip"
                          ? "bg-gradient-gold text-charcoal border-sandalwood"
                          : "border-border bg-card hover:bg-accent/50"
                      )}
                    >
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="w-10 h-10 rounded-xl border border-border bg-card flex items-center justify-center hover:bg-accent/50 transition-colors"
                  >
                    -
                  </button>
              ...
              <div className="pt-4 border-t border-border">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-serif font-semibold flex items-center">
                ...
                <button
                  ...
                  className="btn-divine w-full py-4 text-lg animate-glow-pulse"
                >
                  Book Darshan
                </button>
              </div>
